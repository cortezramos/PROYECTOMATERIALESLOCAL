Public Class clsResizeForm
    ...
    Public Sub ResizeForm(ByVal ObjForm As Form)

        Dim i_StandardHeight As Integer = 501
        Dim i_StandardWidth As Integer = 962

        Dim i_PresentHeight As Integer = System.Windows.Forms.SystemInformation.PrimaryMonitorSize.Height 'Screen.PrimaryScreen.Bounds.Height
        Dim i_PresentWidth As Integer = System.Windows.Forms.SystemInformation.PrimaryMonitorSize.Width 'Screen.PrimaryScreen.Bounds.Width
