...
Imports System.IO
Imports System.Net
Public Class RptOrdenesPorProveedor
#Region "Controles"
    ...
    Sub mostrarReporte()
        ...
        rpt.ServerReport.ReportPath = "/" & vPathReportServer & "/ORDEN PROVEEDOR"
...
#End Region
    ...
    Private Sub RptOrdenesPorProveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
