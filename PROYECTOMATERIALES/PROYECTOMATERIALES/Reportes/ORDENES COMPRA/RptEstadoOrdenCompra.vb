...
Public Class RptEstadoOrdenCompra
#Region "Controles"
    Sub mostrarReporte()
        ...
        rpt.ServerReport.ReportPath = "/" & vPathReportServer & "/ESTADO ORDEN"
...
#End Region
    Private Sub RptEstadoOrdenCompra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnConsultar_Click(sender As Object, e As EventArgs) Handles btnConsultar.Click
        If String.IsNullOrEmpty(txtNumero.Text) = False Then
            mostrarReporte()
        Else
            MsgBox("Ingrese numero de orden a consultar", MsgBoxStyle.Exclamation, "Error de ingreso")
            txtNumero.Focus()
        End If
    End Sub
