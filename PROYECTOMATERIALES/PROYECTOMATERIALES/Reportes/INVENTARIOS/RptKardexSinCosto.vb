...
Public Class RptKardexSinCosto
...
#End Region
        ...
        If CDate(dtFechaI.Text) <= CDate(dtFechaF.Text) Then
            If cmbProducto.SelectedValue > 0 Then
                If cmbBodega.SelectedValue > 0 Then
                    ...
                    rpt.ServerReport.ReportPath = "/" & vPathReportServer & "/KARDEXSC"
                    ...
                    parametros.Add((New ReportParameter("saldo", CBool(1))))
    ...
    Private Sub RptKardexSinCosto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cargarBodegas()
        cargarProductos(Nothing)
