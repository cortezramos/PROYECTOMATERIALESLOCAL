...
#Region "Controles"
    ...
    Sub mostrarReporte()
        ...
        rpt.ServerReport.ReportPath = "/" & vPathReportServer & "/MOVIMIENTO INVENTARIO"
        ...
        parametros.Add(New ReportParameter("saldo", False))
...
#End Region
    ...
    Private Sub RptMovimientoInventario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
