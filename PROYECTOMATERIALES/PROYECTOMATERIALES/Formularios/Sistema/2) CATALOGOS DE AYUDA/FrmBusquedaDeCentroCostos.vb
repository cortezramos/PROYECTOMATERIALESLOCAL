Public Class FrmBusquedaDeCentroCostos
#Region "Controles"
    Sub consultarDatos()
        If dtConsultaCentros.Rows.Count = 0 Then
            dtConsultaCentros = clcentrocosto.consultaCentroDeCostoPantallaBusqueda()
        End If
        With dgvDatos
...
#End Region
    ...
    Public centrocostoseleccion As String
    ...
    Private Sub dgvDatos_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvDatos.CellDoubleClick
        If dgvDatos.Rows.Count > 0 Then
            ...
            centrocostoseleccion = dgvDatos.Item(0, i).Value.ToString()
            txtBuscar.Text = ""
            txtBuscar.Focus()
            buscarDatos()
